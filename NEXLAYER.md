...
**Live:** [https://relaxed-weasel-soketi.cloud.nexlayer.ai](https://relaxed-weasel-soketi.cloud.nexlayer.ai)  

**Runtime:**  · **Port:** auto-detected · **Deploy branch:** 1.x

---

## How this deployment works

**soketi** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
platform where every push to `1.x` triggers a fully automated build-and-deploy
...
application:
  ...
  - name: app
    ...
    - 6001
    vars:
      SOKETI_DEFAULT_APP_ID: "nexlayer-app"
      SOKETI_DEFAULT_APP_KEY: "nexlayer-key"
      SOKETI_DEFAULT_APP_SECRET: "nexlayer-secret"
      SOKETI_DEBUG: "0"
```
...
Triggers on:
- **Push** to `1.x` → production redeploy
...
> `<podName>.pod:<port>` syntax. CI/CD runs on push to `1.x`."*
